...
def handler(event, context):
    ...
    try:
        ...
        lambda_endpoint = "https://lambda.dotblossom.today/api/bedrock"  # 이 람다 함수의 엔드포인트
    ...
    try:
        ...
        api_ctrl_url = "https://dotblossom.today/ai-api/metadata/product/"  # API Gateway URL
        api_url = f"{api_ctrl_url}{productId}"
        headers = {'Content-Type': 'application/json'}
        data = {"product": product_metadata}  # product_metadata를 data 필드에 담아 전송
